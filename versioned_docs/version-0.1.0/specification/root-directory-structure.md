...
description: Description of the CMDS root-level directory structure
---

## About

The CMDS specifies to maintain one directory per datatype at the root level of a dataset. This page provides specification for deciding what constitutes a datatype and how to name each directory.
