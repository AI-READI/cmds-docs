...
description: Description of the general principles of the CMDS
...
The CMDS specifies the following:
...
3.  Within each datatype-specific directory, data and metadata files must be organized according to an existing standard for that datatype, if available, or following the CMDS-suggested structure, as explained [here](datatype-directory-structure.md).
...
<div style={{textAlign: "center"}}>
  <figure>
    <img src="/img/cmds-example.png" alt="cmds-example" width="600" />
    <figcaption>Illustration of the root level of a dataset structured following the CMDS.</figcaption>
  </figure>
</div>
