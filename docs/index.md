---
slug: /
title: Introduction to the CMDS
description: Introduction to the Clinical Multimodal Data Structure (CMDS)
---

# Introduction to the CMDS

## Overview

The Clinical Multimodal Data Structure (CMDS) is a simple and intuitive way to organize and describe clinical research datasets such that they are readily interoperable and easily reusable by humans and machines. The CMDS is especially designed to optimize AI-readiness of datasets.

## Why we need the CMDS
...
The Clinical Multimodal Data Structure (CMDS) is standard established to address these limitations by providing a simple and intuitive way for structuring clinical research data and associated metadata.

## Development of the CMDS

The CMDS is developed as part of the [AI-READI project](https://aireadi.org/) funded by the [NIH Bridge2AI Common Fund](https://commonfund.nih.gov/bridge2ai). We refer to the [Governance section](resources/governance.md) for information regarding the continuous development and maintenance of the CMDS.
