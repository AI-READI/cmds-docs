...
description: Description of the CMDS datatype directory structure
---
...
The CMDS specifies to maintain one directory per datatype at the root level of a dataset. This page provides specification about how data must be organized within each datatype directory.
...
If there is no existing community-agreed standard for structure data from a datatype, the CMDS suggests following this structure within that datatype directory:
